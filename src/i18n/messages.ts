...
export const en = {
  ...
  "tip.label": "Tip jar",
  "tip.copy": "Copy address",
  "tip.copied": "Copied",
  "tip.openWallet": "Send ETH with your wallet",
  "tip.exportNote": "pngn is free. An ETH tip helps keep it that way.",
  ...
  "app.maskThreshold": "Keep more background",
  "app.maskThresholdHintAria": "When to keep more background",
  "app.maskThresholdHint":
    "Raise if the picture around the text got eaten. Lower if specks of the old letters remain.",
  "app.maskExpansion": "Eraser margin",
...
const es = catalog({
  ...
  "footer.copyright": "© {year} pngn",
  "tip.label": "Propina en ETH",
  "tip.copy": "Copiar dirección",
  "tip.copied": "Copiado",
  "tip.openWallet": "Enviar ETH con tu cartera",
  "tip.exportNote":
    "pngn es gratis. Una propina en ETH ayuda a mantenerlo así.",
  ...
  "app.maskThreshold": "Conservar más fondo",
  "app.maskThresholdHintAria": "Cuándo conservar más fondo",
  "app.maskThresholdHint":
    "Súbelo si se comió el entorno del texto. Bájalo si quedan motas de las letras antiguas.",
  "app.maskExpansion": "Margen del borrador",
...
const pl = catalog({
  ...
  "footer.nav": "Stopka",
  "footer.copyright": "© {year} pngn",
  "tip.label": "Napiwek w ETH",
  "tip.copy": "Kopiuj adres",
  "tip.copied": "Skopiowano",
  "tip.openWallet": "Wyślij ETH ze swojego portfela",
  "tip.exportNote": "pngn jest darmowy. Napiwek w ETH pomaga to utrzymać.",
  ...
  "app.maskThreshold": "Zostaw więcej tła",
  "app.maskThresholdHintAria": "Kiedy zostawić więcej tła",
  "app.maskThresholdHint":
    "Podnieś, jeśli zniknęło otoczenie tekstu. Obniż, jeśli zostają drobinki starych liter.",
  "app.maskExpansion": "Margines gumki",
...
const zh = catalog({
  ...
  "tip.copy": "复制地址",
  "tip.copied": "已复制",
  "tip.openWallet": "用钱包发送 ETH",
  "tip.exportNote": "pngn 免费。用 ETH 打赏能帮它继续运作。",
  ...
  "app.maskThreshold": "保留更多背景",
  "app.maskThresholdHintAria": "何时保留更多背景",
  "app.maskThresholdHint":
    "若文字周围的画面被擦掉了就调高；若还剩旧字母碎点就调低。",
  "app.maskExpansion": "橡皮擦边距",
  "app.maskExpansionHintAria": "何时调整橡皮擦边距",
  "app.maskExpansionHint":
    "在每个字母周围多擦一些（像素）。若留下光晕就调高，大字或衬线体尤其如此。",
...
const pcm = catalog({
  ...
  "footer.nav": "Footer",
  "footer.copyright": "© {year} pngn",
  "tip.label": "Give tip with ETH",
  "tip.copy": "Copy di address",
  "tip.copied": "Don copy",
  "tip.openWallet": "Send ETH with your wallet",
  "tip.exportNote": "pngn na free. ETH tip go help keep am so.",
  ...
  "app.maskThresholdHintAria": "When to keep more background",
  "app.maskThresholdHint":
    "Increase am if the picture around the writing don vanish. Reduce am if specks of the old letters still dey.",
  "app.maskExpansion": "Eraser margin",
  "app.maskExpansionHintAria": "When to change eraser margin",
  "app.maskExpansionHint":
...
const ar = catalog({
  ...
  "footer.nav": "تذييل",
  "footer.copyright": "© {year} pngn",
  "tip.label": "إكرامية بـ ETH",
  "tip.copy": "نسخ العنوان",
  "tip.copied": "تم النسخ",
  "tip.openWallet": "أرسل ETH من محفظتك",
  "tip.exportNote": "pngn مجاني. إكرامية بـ ETH تساعد على الإبقاء عليه كذلك.",
  ...
  "app.maskThreshold": "الإبقاء على المزيد من الخلفية",
  "app.maskThresholdHintAria": "متى تبقي على المزيد من الخلفية",
  "app.maskThresholdHint":
    "ارفعها إن اختفى ما حول النص. اخفضها إن بقيت نقاط من الحروف القديمة.",
  "app.maskExpansion": "هامش الممحاة",
